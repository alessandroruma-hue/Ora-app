...
function MapScreen({ alerts, lastUpdatedLabel, activeFilters, onToggleFilter, onOpenNumeri, onSeeAll, onProfile, onNewReport, onOpenNotifications, unreadCount, onFlag, flaggedIds, userId, onDelete, onEdit }) {
